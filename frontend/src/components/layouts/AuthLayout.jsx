...
const cardImageUrl = "https://placehold.co/400x250/e9d5ff/7c3aed?text=Expense+Card";
...
const StatsInfoCard = ({ icon, label, value, color }) => {
    return (
        <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-100 border border-gray-200/50 z-10">
